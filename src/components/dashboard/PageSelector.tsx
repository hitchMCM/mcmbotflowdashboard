    ...
    return (
      <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5">
        <Avatar className="h-6 w-6">
          <AvatarImage src={page.avatar_url || `https://api.dicebear.com/7.x/shapes/svg?seed=${page.fb_page_id}`} />
            ...
            {currentPage ? (
              <>
                <Avatar className="h-5 w-5">
                  <AvatarImage src={currentPage.avatar_url || `https://api.dicebear.com/7.x/shapes/svg?seed=${currentPage.fb_page_id}`} />
